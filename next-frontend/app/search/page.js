  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-10 px-2">
      ...
      <div className="w-full max-w-2xl flex flex-col items-center mb-10">
        ...
        <p className="text-gray-500 text-center mb-2 max-w-lg">Describe your vehicle and the problem. Instantly get the best YouTube tutorials to help you fix it yourself.</p>
      </div>
      {/* Search Card */}
